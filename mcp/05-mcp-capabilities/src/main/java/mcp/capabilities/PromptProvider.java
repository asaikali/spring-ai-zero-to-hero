...
public class PromptProvider {
  ...
  public GetPromptResult personalizedMessage(
    ...
    message.append(
        "I'm here to assist you with any questions you might have about the Model Context Protocol.");
  ...
  public List<PromptMessage> conversationStarter(GetPromptRequest request) {
    return List.of(
        ...
        new PromptMessage(
            Role.USER, new TextContent("I'd like to learn more about the Model Context Protocol.")),
        new PromptMessage(
            Role.ASSISTANT,
            new TextContent(
